...
async def get_opportunity(
    ...
    try:
        ...
        return StandardResponse(
            ...
            data=OpportunityResponse.from_orm(opportunity),
        )
...
async def create_opportunity(
    ...
    try:
        ...
        return StandardResponse(
            status=True, message="Opportunity created successfully", data=opportunity
        )
...
async def update_opportunity_stage(
    ...
    try:
        opportunity = opportunity_service.update_stage(
            opportunity_id, stage_data.stage.value, current_user["id"], stage_data.notes
        )
        if not opportunity:
            raise HTTPException(status_code=404, detail="Opportunity not found")
