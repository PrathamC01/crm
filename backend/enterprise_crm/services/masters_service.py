...
from ..schemas.common import BaseFilter, PaginatedResponse, ApprovalRequest
...
class MastersService:
    ...
    def _price_list_to_dict(self, price_list: PriceListMaster) -> dict:
        ...
        return {
            ...
            "is_approved": price_list.is_approved,
    ...
    def _product_pricing_to_dict(self, pricing: ProductPricingMaster) -> dict:
        ...
        return {
            ...
            "is_approved": pricing.is_approved,
