...
import { opportunityAPI, apiRequest, OPPORTUNITY_STAGES, OPPORTUNITY_STAGE_LABELS, OPPORTUNITY_STATUSES, QUALIFICATION_STATUSES, GO_NO_GO_STATUSES, QUOTATION_STATUSES } from '../../../utils/api';

const EnhancedOpportunityForm = ({ opportunity, onSave, onCancel }) => {
  ...
  useEffect(() => {
    if (opportunity) {
      setFormData({
        ...opportunity,
        // Handle date fields
        demo_date: opportunity.demo_date ? new Date(opportunity.demo_date).toISOString().slice(0, 16) : '',
        qualification_meeting_date: opportunity.qualification_meeting_date ? new Date(opportunity.qualification_meeting_date).toISOString().slice(0, 16) : '',
        proposal_submission_date: opportunity.proposal_submission_date ? new Date(opportunity.proposal_submission_date).toISOString().slice(0, 16) : '',
        kickoff_meeting_date: opportunity.kickoff_meeting_date ? new Date(opportunity.kickoff_meeting_date).toISOString().slice(0, 16) : '',
  ...
  const renderQualificationTab = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-1">Requirement Gathering Notes</label>
          <textarea
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Go/No Go Call Status</label>
          <select
        ...
        <div>
          ...
          >
            ...
            <option value={QUALIFICATION_STATUSES.DISQUALIFIED}>Disqualified</option>
          </select>
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Scoring (0-100)</label>
          <input
            type="number"
            name="scoring"
            min="0"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="demo_completed" className="text-sm font-medium text-gray-700">
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-1">Demo Summary</label>
          <textarea
            name="demo_summary"
            rows="3"
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="qualification_meeting_completed" className="text-sm font-medium text-gray-700">
            Qualification Meeting with Customer Completed
          </label>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Qualification Meeting Date</label>
          <input
            type="datetime-local"
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-1">Qualification Meeting Notes</label>
          <textarea
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="quotation_created" className="text-sm font-medium text-gray-700">
            Quotation Created
          </label>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Quotation Status</label>
          <select
          ...
          >
            ...
            <option value={QUOTATION_STATUSES.REVISION_REQUIRED}>Revision Required</option>
          </select>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Quotation Version</label>
          <input
            type="number"
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="proposal_prepared" className="text-sm font-medium text-gray-700">
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="proposal_submitted" className="text-sm font-medium text-gray-700">
            Proposal Submitted
          </label>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Proposal Submission Date</label>
          <input
            type="datetime-local"
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="poc_completed" className="text-sm font-medium text-gray-700">
            POC Completed
          </label>
        </div>

        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-1">POC Notes</label>
          <textarea
            name="poc_notes"
            rows="3"
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-1">Solutions Team Approval Notes</label>
          <textarea
  ...
  const renderNegotiationTab = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-1">Discussion with Customer</label>
          <textarea
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="proposal_updated" className="text-sm font-medium text-gray-700">
            Proposal Updated
          </label>
        </div>
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="updated_proposal_submitted" className="text-sm font-medium text-gray-700">
            Updated Proposal Submitted
          </label>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Negotiation Rounds</label>
          <input
            type="number"
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="commercial_approval_required" className="text-sm font-medium text-gray-700">
            Commercial Approval Required
          </label>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Commercial Approval Status</label>
          <input
            type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="kickoff_meeting_scheduled" className="text-sm font-medium text-gray-700">
            Kick Off Meeting Scheduled
          </label>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Kick Off Meeting Date</label>
          <input
            type="datetime-local"
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="loi_received" className="text-sm font-medium text-gray-700">
            LOI / Order Received
          </label>
        </div>
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="order_verified" className="text-sm font-medium text-gray-700">
        ...
        <div className="flex items-center">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="handoff_to_delivery" className="text-sm font-medium text-gray-700">
            Handoff to Delivery Team
          </label>
        </div>

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Delivery Team Assigned</label>
          <select
...
export default EnhancedOpportunityForm;