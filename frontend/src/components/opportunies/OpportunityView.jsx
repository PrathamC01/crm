      ...
      <div className="bg-white p-6 rounded-lg border">
        ...
        <dl className="space-y-3">
          ...
          <div>
            ...
            <dd className="text-sm text-gray-900">
              {formatDate(opportunity.created_on)}
            </dd>
          </div>
        </dl>
      </div>
        ...
        <div className="space-y-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd
                className={`text-sm inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
        ...
        <dl className="space-y-3">
          ...
          {opportunity.costing && (
            <div>
              ...
              <dd className="text-sm text-gray-900">
                {formatCurrency(opportunity.costing)}
              </dd>
            </div>
          )}
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd
                className={`text-sm inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                  opportunity.go_no_go_status === "Go"
                    ? "bg-green-100 text-green-800"
                    : opportunity.go_no_go_status === "No_Go"
                    ? "bg-red-100 text-red-800"
            ...
            <div>
              ...
              >
                {opportunity.qualification_status?.replace("_", " ") ||
                  "Pending"}
              </dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-gray-900">
                {opportunity.qualification_completer_name || "Not assigned"}
              </dd>
            </div>
          </dl>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          {opportunity.requirement_gathering_notes ? (
            ...
            <div className="text-sm text-gray-500">
              No requirement notes captured yet
            </div>
          )}
        </div>
          ...
          <div className="bg-white p-6 rounded-lg border md:col-span-2">
            ...
            <div className="text-sm text-gray-900">
              <pre className="whitespace-pre-wrap">
                {JSON.stringify(opportunity.qualification_scorecard, null, 2)}
              </pre>
            </div>
          </div>
        )}
  ...
  const renderDemoTab = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg border">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.demo_completed ? "text-green-600" : "text-red-600"
                }`}
              >
            ...
            {opportunity.demo_date && (
              <div>
                ...
                <dd className="text-sm text-gray-900">
                  {formatDate(opportunity.demo_date)}
                </dd>
              </div>
            )}
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.qualification_meeting_completed
                    ? "text-green-600"
                    : "text-red-600"
                }`}
              >
            ...
            {opportunity.qualification_meeting_date && (
              <div>
                ...
                <dd className="text-sm text-gray-900">
                  {formatDate(opportunity.qualification_meeting_date)}
                </dd>
              </div>
            )}
          </dl>
        ...
        {opportunity.presentation_materials &&
          opportunity.presentation_materials.length > 0 && (
            <div className="bg-white p-6 rounded-lg border md:col-span-2">
              <h3 className="text-lg font-medium text-gray-900 mb-4">
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <dl className="space-y-3">
            ...
            <div>
              ...
              <dd
                className={`text-sm inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                  opportunity.quotation_status === "Approved"
                    ? "bg-green-100 text-green-800"
                    : opportunity.quotation_status === "Submitted"
                    ? "bg-blue-100 text-blue-800"
                    : opportunity.quotation_status === "Revision_Required"
                    ? "bg-yellow-100 text-yellow-800"
                    : "bg-gray-100 text-gray-800"
                }`}
              >
            ...
            <div>
              ...
              <dd className="text-sm text-gray-900">
                {opportunity.quotation_version || 1}
              </dd>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <dl className="space-y-3">
            ...
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.proposal_submitted
                    ? "text-green-600"
                    : "text-red-600"
                }`}
              >
            ...
            {opportunity.proposal_submission_date && (
              <div>
                ...
                <dd className="text-sm text-gray-900">
                  {formatDate(opportunity.proposal_submission_date)}
                </dd>
              </div>
            )}
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.poc_completed ? "text-green-600" : "text-red-600"
                }`}
              >
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-sm text-gray-900">
                {opportunity.negotiation_rounds || 0}
              </dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-gray-500">
            ...
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.updated_proposal_submitted
                    ? "text-green-600"
                    : "text-red-600"
                }`}
              >
          ...
          <dl className="space-y-3">
            ...
            {opportunity.commercial_approval_required && (
              <div>
                ...
                <dd
                  className={`text-sm inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                    opportunity.commercial_approval_status === "Approved"
                      ? "bg-green-100 text-green-800"
                      : opportunity.commercial_approval_status === "Rejected"
                      ? "bg-red-100 text-red-800"
                      : "bg-yellow-100 text-yellow-800"
                  }`}
                >
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.kickoff_meeting_scheduled
                    ? "text-green-600"
                    : "text-red-600"
                }`}
              >
            ...
            {opportunity.kickoff_meeting_date && (
              <div>
                ...
                <dd className="text-sm text-gray-900">
                  {formatDate(opportunity.kickoff_meeting_date)}
                </dd>
              </div>
            )}
          </dl>
        ...
        <div className="bg-white p-6 rounded-lg border">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.loi_received ? "text-green-600" : "text-red-600"
                }`}
              >
            ...
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.order_verified ? "text-green-600" : "text-red-600"
                }`}
              >
        ...
        <div className="bg-white p-6 rounded-lg border md:col-span-2">
          ...
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <dd
                className={`text-sm ${
                  opportunity.handoff_to_delivery
                    ? "text-green-600"
                    : "text-red-600"
                }`}
              >
        ...
        <div className="space-y-4">
          <div className="border-l-4 border-blue-500 pl-4">
            ...
            <div className="text-xs text-gray-400">
              by {opportunity.created_by_name}
            </div>
          </div>

          {opportunity.updated_on &&
            opportunity.updated_on !== opportunity.created_on && (
              <div className="border-l-4 border-yellow-500 pl-4">
                <div className="text-sm font-medium text-gray-900">
                  Last Updated
                </div>
                <div className="text-sm text-gray-500">
                  {formatDate(opportunity.updated_on)}
                </div>
              </div>
            )}
          ...
          {opportunity.status !== "Open" && opportunity.close_date && (
            ...
            >
              ...
              {opportunity.competitor_name && (
                <div className="text-xs text-gray-400">
                  Competitor: {opportunity.competitor_name}
                </div>
              )}
              {opportunity.drop_reason && (
                <div className="text-xs text-gray-400">
                  Reason: {opportunity.drop_reason}
                </div>
              )}
            </div>
          )}
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            {opportunity.company_name} | {opportunity.contact_name} |{" "}
            {formatCurrency(opportunity.amount)}
          </p>
        </div>
      ...
      <div className="bg-white p-4 rounded-lg border">
        ...
        <div className="text-sm text-gray-600">
          {opportunity.stage_percentage}% Complete | Probability:{" "}
          {opportunity.probability}% | Score: {opportunity.scoring}/100
        </div>
      </div>
