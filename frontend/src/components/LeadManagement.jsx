...
const LeadManagement = () => {
  ...
  const handleDelete = async (lead) => {
    if (
      !window.confirm(
        `Are you sure you want to delete "${lead.project_title}"?`
      )
    )
      return;
      ...
      <div className="bg-white p-6 rounded-lg shadow border">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <div className="text-2xl font-bold text-gray-900">
              {stats.approved_for_conversion || 0}
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <div className="text-2xl font-bold text-gray-900">
              ₹
              {stats.total_value
                ? new Intl.NumberFormat("en-IN").format(stats.total_value)
                : "0"}
            </div>
          </div>
        </div>
      ...
      {view === "list" && (
        <div className="bg-white p-6 rounded-lg shadow border">
          <h3 className="text-lg font-medium text-gray-900 mb-4">
            Lead Management & Conversion Process
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            <div>
              ...
              <ul className="text-gray-600 space-y-1">
                <li>
                  • <strong>General Details:</strong> Project info, lead source,
                  company details
                </li>
                <li>
                  • <strong>Contact Management:</strong> Decision makers and
                  stakeholders
                </li>
                <li>
                  • <strong>Tender Information:</strong> Fees, dates, submission
                  requirements
                </li>
                <li>
                  • <strong>Documentation:</strong> Upload tender docs and
                  specifications
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-gray-600 space-y-1">
                <li>
                  • <strong>Qualification:</strong> BANT/CHAMP scoring and
                  validation
                </li>
                <li>
                  • <strong>Nurturing:</strong> Follow-ups and relationship
                  building
                </li>
                <li>
                  • <strong>Conversion:</strong> Convert qualified leads to
                  opportunities
                </li>
                <li>
                  • <strong>Tracking:</strong> Monitor progress and update
                  status
                </li>
              </ul>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <div className="text-purple-800">
                  Lead reaches "Qualified" status through proper assessment
                </div>
              </div>
              <div className="space-y-2">
                <div className="font-medium text-purple-900">
                ...
                <div className="text-purple-800">
                  Sales team clicks "Convert to Opportunity" button
                </div>
              </div>
              <div className="space-y-2">
                <div className="font-medium text-purple-900">
                ...
                <div className="text-purple-800">
                  Admin/Reviewer approves or rejects conversion request
                </div>
              </div>
              <div className="space-y-2">
                <div className="font-medium text-purple-900">
                ...
                <div className="text-purple-800">
                  Approved leads get converted to opportunities with POT-ID
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 p-4 bg-green-50 rounded-lg">
            ...
            <p className="text-sm text-green-800 mt-1">
              Use the multi-tab form to capture comprehensive lead information.
              Once qualified, use the "Convert to Opportunity" workflow with
              proper admin review to ensure quality opportunity creation and
              maintain audit trails for all conversions.
            </p>
          </div>
        </div>
      )}
